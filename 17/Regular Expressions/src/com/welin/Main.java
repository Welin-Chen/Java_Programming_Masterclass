...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String tvString = "tstvtkt";
//        String tNotVRegExp="t[^v]";
        String tNotVRegExp = "t(?!v)";
        Pattern tNotVPattern = Pattern.compile(tNotVRegExp);
        Matcher tNotVMatcher = tNotVPattern.matcher(tvString);
        ...
        String phoneFormat = "^([\\(]{1}[0-9]{3}[\\)]{1}[ ]{1}[0-9]{3}[\\-]{1}[0-9]{4})$";
        String phone1 = "1234567890";
        String phone2 = "(123) 456-7890";
        String phone3 = "123 456-7890";
        String phone4 = "(123)456-7890";

        System.out.println("phone1 = " + phone1.matches(phoneFormat));
        System.out.println("phone2 = " + phone2.matches(phoneFormat));
        System.out.println("phone3 = " + phone3.matches(phoneFormat));
        System.out.println("phone4 = " + phone4.matches(phoneFormat));


        String visaFormat = "^4[0-9]{12}([0-9]{3})?$";
        String visa1 = "4444444444444";
        String visa2 = "5444444444444";
        String visa3 = "4444444444444444";
        String visa4 = "4444";

        System.out.println("visa1 = " + visa1.matches(visaFormat));
        System.out.println("visa2 = " + visa2.matches(visaFormat));
        System.out.println("visa3 = " + visa3.matches(visaFormat));
        System.out.println("visa4 = " + visa4.matches(visaFormat));
